...
def run_analysis(data_folder, output_dir, primary_condition_col, control_value, secondary_condition_col=None, significance_threshold=0.05):
    """
...
def main():
    ...
    if not os.path.exists(args.data_dir):
        ...
        run_analysis(args.data_dir, args.output_dir, args.primary_col, args.control_val, args.secondary_col, args.significance_threshold)
